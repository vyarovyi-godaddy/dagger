...
import static dagger.internal.codegen.InjectAdapterProcessor.JDK_SOURCE_COMPATIBILITY;
...
final class GeneratorKeys {
  ...
  private static void qualifierToString(AnnotationMirror qualifier, StringBuilder result) {
    ...
    if (JDK_SOURCE_COMPATIBILITY >= 15) {
      // JDK 15 breaking change: Make javac's toString() on annotation objects consistent with core reflection
